...
_A live bird collage from your window._
...
Installer assumes passwordless sudo (Raspberry Pi OS Lite default - if you've tightened it, run `sudo raspi-config` -> _System Options_ -> restore the default first).
